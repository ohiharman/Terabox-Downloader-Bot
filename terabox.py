...
async def start_command(client: Client, message: Message):
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/premium_mod_jacksparow")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/premium_mod_jacksparow")
    repo69 = InlineKeyboardButton("ʀᴇᴘᴏ 🌐", url="https://t.me/premium_mod_jacksparow")
